...
const SponsorPane = ({ companyName, image, description, link }) => (
    <div style={{position: 'relative', width: '320px', height: '280px', background: '#14375c', borderRadius: '10px', paddingLeft: '20px', paddingRight: '20px', paddingTop: '10px', marginRight: '20px', marginBottom: '20px'}}>
        ...
        <div style={{position: 'absolute', bottom: '20px', width: '280px', height: '80px', background: 'white', borderRadius: '10px'}}>
